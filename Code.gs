...
// ตรงตามตาราง Manpower Meeting (สเปคทางการ) · หลายลำ → ใช้แถวลำใหญ่สุด (TTL มากสุด) · TTL = จำนวนคนจริง
// · GATE = Gate Controller (1) เพราะ Gate Agent มาจาก check-in counter (นับใน CI) · 6E แยกเกท → GATE = GC+GA
var SLA_RQ = {
  '3K':[1,4,1,1,7], '3U':[1,4,1,1,8], '6B':[1,5,2,1,8], '6E':[1,5,1,5,12], '8L':[1,4,1,1,8], '8M':[1,3,1,1,7],
  '9C':[1,5,1,1,8], '9H':[1,4,1,1,8], 'AF':[1,9,1,1,11], 'AI':[1,6,1,1,10], 'AK':[1,3,1,1,7], 'AQ':[1,3,1,1,7],
  'AY':[1,5,1,1,9], 'BY':[1,5,2,1,8], 'C6':[1,4,1,1,8], 'CA':[1,6,1,1,10], 'CX':[1,6,2,1,10], 'CZ':[1,6,1,1,10],
  'DE':[1,6,2,1,9], 'DK':[1,7,1,1,10], 'DV':[1,4,1,1,8], 'EK':[1,7,3,1,12], 'EO':[1,6,1,1,10], 'EY':[1,9,1,1,13],
  'FM':[1,4,1,1,8], 'FY':[1,4,1,1,7], 'G2':[1,6,1,1,10], 'G8':[1,4,1,1,8], 'G9':[1,4,1,1,8], 'HB':[1,4,1,1,8],
  'HH':[1,4,1,1,8], 'HO':[1,4,1,1,8], 'HU':[1,6,1,1,10], 'HX':[1,5,1,1,9], 'HY':[1,5,1,1,9], 'IT':[1,4,1,1,8],
  'IX':[1,4,1,1,8], 'JQ':[1,7,1,1,12], 'KC':[1,5,1,1,8], 'KE':[1,8,1,1,12], 'KY':[1,4,1,1,7], 'LJ':[1,4,1,1,7],
  'LO':[1,6,1,1,10], 'LY':[1,8,1,1,12], 'MH':[1,4,1,1,6], 'MU':[1,4,1,1,8], 'N0':[1,5,1,1,11], 'N4':[1,6,1,1,10],
  'NO':[1,6,1,1,10], 'OD':[1,5,1,1,9], 'OM':[1,4,1,1,6], 'OQ':[1,4,1,1,8], 'OV':[1,4,1,1,7], 'OZ':[1,6,1,1,9],
  'PG':[1,0,1,2,8], 'PN':[1,4,1,1,8], 'QP':[1,4,1,1,8], 'QR':[1,11,2,1,21], 'QZ':[1,3,1,1,7], 'S7':[1,4,1,1,8],
  'SG':[1,4,1,1,8], 'SQ':[1,5,1,1,7], 'SU':[1,8,1,1,12], 'TK':[1,8,4,1,12], 'TR':[1,6,1,1,9], 'U6':[1,4,1,1,8],
  'UO':[1,4,2,1,8], 'VJ':[1,5,1,1,9], 'W5':[1,7,1,1,10], 'WK':[1,6,1,1,10], 'WY':[1,7,1,1,12], 'WZ':[1,6,1,1,10],
  'ZF':[1,6,1,1,10], 'ZH':[1,4,1,1,8],
};
...
// ── บทบาทเต็มตามตาราง Manpower per Job (สำหรับแท็บ "จัดล่วงหน้า" + คอลัมน์ Flights) ─
// [SUP, FC, Check-in, Arrival, Standby, GateController, Gate Agent, Crew Sign, sepGate, total]
// ตรงตามสเปคทางการ · หลายลำ → แถวลำใหญ่สุด · Crew Sign แยกออกจาก Gate Agent แล้ว · 6E sepGate=1
var SLA_ROLES = {
  '3K':[1,1,4,1,0,1,3,1,0,7], '3U':[1,1,4,1,0,1,3,1,0,8], '6B':[1,1,5,2,0,1,4,1,0,8], '6E':[1,1,5,1,0,1,4,1,1,12],
  '8L':[1,1,4,1,0,1,3,1,0,8], '8M':[1,1,3,1,0,1,4,1,0,7], '9C':[1,1,5,1,0,1,3,1,0,8], '9H':[1,1,4,1,0,1,3,1,0,8],
  'AF':[1,1,9,1,0,1,4,1,0,11], 'AI':[1,1,6,1,0,1,3,1,0,10], 'AK':[1,1,3,1,0,1,4,1,0,7], 'AQ':[1,1,3,1,0,1,3,1,0,7],
  'AY':[1,1,5,1,0,1,4,1,0,9], 'BY':[1,1,5,2,0,1,4,1,0,8], 'C6':[1,1,4,1,0,1,3,1,0,8], 'CA':[1,1,6,1,0,1,3,1,0,10],
  'CX':[1,1,6,2,0,1,5,1,0,10], 'CZ':[1,1,6,1,0,1,3,1,0,10], 'DE':[1,1,6,2,0,1,5,1,0,9], 'DK':[1,1,7,1,0,1,5,1,0,10],
  'DV':[1,1,4,1,0,1,4,1,0,8], 'EK':[1,1,7,3,0,1,5,1,0,12], 'EO':[1,1,6,1,0,1,5,1,0,10], 'EY':[1,1,9,1,0,1,5,1,0,13],
  'FM':[1,1,4,1,0,1,3,1,0,8], 'FY':[1,1,4,1,0,1,3,1,0,7], 'G2':[1,1,6,1,0,1,4,1,0,10], 'G8':[1,1,4,1,0,1,3,1,0,8],
  'G9':[1,1,4,1,0,1,3,1,0,8], 'HB':[1,1,4,1,0,1,3,1,0,8], 'HH':[1,1,4,1,0,1,4,1,0,8], 'HO':[1,1,4,1,0,1,3,1,0,8],
  'HU':[1,1,6,1,0,1,3,1,0,10], 'HX':[1,1,5,1,0,1,3,1,0,9], 'HY':[1,1,5,1,0,1,4,1,0,9], 'IT':[1,1,4,1,0,1,4,1,0,8],
  'IX':[1,1,4,1,0,1,3,1,0,8], 'JQ':[1,1,7,1,0,1,7,2,0,12], 'KC':[1,1,5,1,0,1,3,1,0,8], 'KE':[1,1,8,1,0,1,3,1,0,12],
  'KY':[1,1,4,1,0,1,3,1,0,7], 'LJ':[1,1,4,1,0,1,3,1,0,7], 'LO':[1,1,6,1,0,1,4,1,0,10], 'LY':[1,1,8,1,0,1,9,1,0,12],
  'MH':[1,1,4,1,0,1,3,1,0,6], 'MU':[1,1,4,1,0,1,3,1,0,8], 'N0':[1,1,5,1,0,1,4,1,0,11], 'N4':[1,1,6,1,0,1,5,1,0,10],
  'NO':[1,1,6,1,0,1,5,1,0,10], 'OD':[1,1,5,1,0,1,4,1,0,9], 'OM':[1,1,4,1,0,1,3,1,0,6], 'OQ':[1,1,4,1,0,1,3,1,0,8],
  'OV':[1,1,4,1,0,1,3,1,0,7], 'OZ':[1,1,6,1,0,1,4,1,0,9], 'PG':[1,1,0,1,0,2,4,0,0,8], 'PN':[1,1,4,1,0,1,3,1,0,8],
  'QP':[1,1,4,1,0,1,3,1,0,8], 'QR':[1,1,11,2,0,1,5,1,0,21], 'QZ':[1,1,3,1,0,1,4,1,0,7], 'S7':[1,1,4,1,0,1,3,1,0,8],
  'SG':[1,1,4,1,0,1,4,1,0,8], 'SQ':[1,1,5,1,0,1,4,1,0,7], 'SU':[1,1,8,1,0,1,4,1,0,12], 'TK':[1,1,8,4,0,1,4,1,0,12],
  'TR':[1,1,6,1,0,1,5,1,0,9], 'U6':[1,1,4,1,0,1,4,1,0,8], 'UO':[1,1,4,2,0,1,4,1,0,8], 'VJ':[1,1,5,1,0,1,4,1,0,9],
  'W5':[1,1,7,1,0,1,4,1,0,10], 'WK':[1,1,6,1,0,1,4,1,0,10], 'WY':[1,1,7,1,0,1,7,1,0,12], 'WZ':[1,1,6,1,0,1,5,1,0,10],
  'ZF':[1,1,6,1,0,1,4,1,0,10], 'ZH':[1,1,4,1,0,1,3,1,0,8],
};
/** บทบาทเต็มต่อไฟลท์ → {SUP,FC,CI,ARR,STB,GM,GA,CS,sep,total} (GM = Gate Controller, CS = Crew Sign) */
function slaRoles_(airline) {
  var c = String(airline || '').toUpperCase();
  var r = SLA_ROLES[c] || (SLA_ALIAS[c] && SLA_ROLES[SLA_ALIAS[c]]);
  if (!r) { var q = slaReq_(airline); return { SUP: 1, FC: 1, CI: q.CI, ARR: q.ARR, STB: 0, GM: 1, GA: Math.max(0, (q.total || 0) - 4 - q.CI - q.ARR), CS: 1, sep: false, total: q.total }; }
  return { SUP: r[0], FC: r[1], CI: r[2], ARR: r[3], STB: r[4], GM: r[5], GA: r[6], CS: r[7], sep: !!r[8], total: r[9] };
}
...
function slaPhasesOf_(task) {
  ...
  if (/\bCT\b|\bC\d|^C\b|\bY\d|\bJ\d|\bW\d|WEB|KIOSK|PRIO|PSM|\bSD\b|CHECK|CKIN|CREW|\bCS\b|\bFR\b|COUNTER/.test(u)) p.CI = 1;   // เช็คอิน/เคาน์เตอร์/crew sign
...
function rbFlightsHtml(iso) {
  try {
    ...
    return rbTblCard_('✈️ ไฟลท์บินประจำวัน + เช็ค SLA สายการบิน',
      '<tr><th>Flight</th><th>สายการบิน</th><th>ทีม</th><th>STA</th><th>STD</th><th>จัด/รวม</th><th>SUP</th><th>FC</th><th>Check-in</th><th>Arrival</th><th>Gate<br>Controller</th><th>Gate<br>Agent</th><th>Crew<br>Sign</th><th>สถานะ</th></tr>',
...
function rbBuildDashboardHtml_(res, ll, master, date, iso, base, tz, staticMode) {
  ...
  return '<!doctype html><html lang="th" data-theme="corporate"><head><meta charset="utf-8">' +
    ...
    'function loadTT(){lazy("ttbox","rbTimetableHtml","tt");}function loadFlt(){lazy("fltbox","rbFlightsHtml","flt");}function loadOT(){}function loadAC(){lazy("acbox","rbAssignHtml","ac");}function loadSup(){lazy("supbox","rbSupportHtml","sup");}function loadDeploy(){lazy("deploybox","rbDeployedHtml","deploy");}' +
