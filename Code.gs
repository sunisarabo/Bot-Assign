...
var SLA_RQ = {
  ...
  'PG':[1,0,1,2,8], 'PN':[1,4,1,1,8], 'QP':[1,4,1,1,8], 'QR':[1,9,2,1,19], 'QZ':[1,3,1,1,7], 'S7':[1,4,1,1,8],
...
var SLA_ROLES = {
  ...
  'QP':[1,1,4,1,0,1,3,1,0,8], 'QR':[1,1,9,2,0,1,5,1,0,19], 'QZ':[1,1,3,1,0,1,4,1,0,7], 'S7':[1,1,4,1,0,1,3,1,0,8],
