/**
 * SmartShift Roster Bot — All-in-One (PSA+LL+Master+Web+Timetable+SLA+WeeklyOT, AOTGA CI)
 * แท็บ: Dashboard / Timetable / Flights+SLA / Support / OT รายสัปดาห์(>36h) | กราฟมีตัวเลข
 */
